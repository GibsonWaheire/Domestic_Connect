...
import {
  Users, MapPin, Star, Zap, Menu, MessageCircle, HelpCircle,
      ...
      <header className="border-b border-gray-100 bg-white sticky top-0 z-40">
        <div className="max-w-[1100px] mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-3">
            ...
            <Link to="/contact-us" className="text-sm font-medium text-gray-600 hover:text-black transition-colors px-3 py-1.5">Contact Us</Link>
          </nav>
